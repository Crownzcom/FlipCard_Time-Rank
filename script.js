...
document.addEventListener('DOMContentLoaded', function () {
  clearTextContent() // Clear any dynamically added content.
...
function showWinModal () {
  ...
  sendTimeToServer(timeString)
    ...
    .catch(error => {
      // If there's an error communicating with the server, hide the spinner, show the restart button, and display an error message.
      spinner.style.display = 'none'
